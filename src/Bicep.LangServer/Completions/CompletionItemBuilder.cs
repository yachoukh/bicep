...
namespace Bicep.LanguageServer.Completions
{
    public class CompletionItemBuilder
    {
        ...
        public CompletionItemBuilder WithInsertText(string insertText, InsertTextMode insertTextMode = InsertTextMode.AsIs)
        {
        ...
        public CompletionItemBuilder WithPlainTextEdit(Range range, string text, InsertTextMode insertTextMode = InsertTextMode.AsIs)
        {
            this.AssertNoInsertText();
            this.SetTextEditInternal(range, InsertTextFormat.PlainText, text, insertTextMode);
            return this;
        }

        public CompletionItemBuilder WithSnippet(string snippet, InsertTextMode insertTextMode = InsertTextMode.AsIs)
        {
            this.AssertNoTextEdit();
        ...
        public CompletionItemBuilder WithSnippetEdit(Range range, string snippet, InsertTextMode insertTextMode = InsertTextMode.AsIs)
        {
            this.AssertNoInsertText();
            this.SetTextEditInternal(range, InsertTextFormat.Snippet, snippet, insertTextMode);
            return this;
        }
        ...
        private void SetTextEditInternal(Range range, InsertTextFormat format, string text, InsertTextMode insertTextMode)
        {
